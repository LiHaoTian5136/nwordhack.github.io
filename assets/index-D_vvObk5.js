...
Mk = () => {
    ...
    }]; // Only the "Exclusive" plan remains

    return d.jsxs("div", {
        className: "py-20 px-4 relative overflow-hidden flex justify-center items-center", // Center the content
        children: [d.jsxs("div", {
            className: "absolute inset-0 pointer-events-none",
            children: [d.jsx("div", {
            ...
            children: d.jsx("div", {
                className: "flex justify-center", // Center the "Exclusive" plan
